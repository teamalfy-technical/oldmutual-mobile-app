...
class PRecommendationHighlightPage extends StatelessWidget {
  final Highlight highlight;
  PRecommendationHighlightPage({super.key, required this.highlight});
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton(
                        onPressed: () => PPopupDialog(context).warningMessage(
                          title: 'coming_soon_title'.tr,
                          message: 'coming_soon_msg'.tr,
                        ),
                        //PHelperFunction.pop,
