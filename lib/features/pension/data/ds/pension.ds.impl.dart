...
final PensionDs pensionDs = Get.put(PensionDsImpl());

class PensionDsImpl implements PensionDs {
  @override
  ...
  @override
  Future<ApiResponse<PensionSummary>> getPensionSummary() async {
    final res = await apiService.callService(
      requestType: RequestType.get,
      endPoint: Env.getPensionSummary,
    );
