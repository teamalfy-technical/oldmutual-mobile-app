...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/arrow.forward.ios.svg
  SvgGenImage get arrowForwardIos =>
      const SvgGenImage('assets/icons/arrow.forward.ios.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dark.blur.bg.png
  AssetGenImage get darkBlurBg =>
      const AssetGenImage('assets/images/dark.blur.bg.png');

  /// File path: assets/images/dashboard.bg.png
  ...
  /// File path: assets/images/slide.one.png
  AssetGenImage get slideOne =>
      const AssetGenImage('assets/images/slide.one.png');

  /// File path: assets/images/slide.three.png
  AssetGenImage get slideThree =>
      const AssetGenImage('assets/images/slide.three.png');

  /// File path: assets/images/slide.two.png
...
class $AssetsLottiesGen {
  ...
  /// File path: assets/lotties/no-internet.json
  LottieGenImage get noInternet =>
      const LottieGenImage('assets/lotties/no-internet.json');

  /// File path: assets/lotties/no-record.json
  LottieGenImage get noRecord =>
      const LottieGenImage('assets/lotties/no-record.json');

  /// File path: assets/lotties/slide-one.json
  LottieGenImage get slideOne =>
      const LottieGenImage('assets/lotties/slide-one.json');

  /// File path: assets/lotties/slide-three.json
  LottieGenImage get slideThree =>
      const LottieGenImage('assets/lotties/slide-three.json');

  /// File path: assets/lotties/slide-two.json
  LottieGenImage get slideTwo =>
      const LottieGenImage('assets/lotties/slide-two.json');
